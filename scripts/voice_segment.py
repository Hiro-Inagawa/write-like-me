...
DETERMINERS = r"(?!(?:The|This|That|These|Those|A|An|Our|My|Its|Their|His|Her|Your|One|Every|Each)\b)"
LABEL = re.compile(r"^\s*(?:\*\*|__)?" + DETERMINERS + r"[A-Z][A-Za-z]*(?: [A-Za-z]+){0,2}:(?:\*\*|__)?\s+\S")
